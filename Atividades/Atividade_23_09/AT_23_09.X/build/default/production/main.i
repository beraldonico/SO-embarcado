...
float analog, pulse_time, active_per, flag_time;
# 5 "main.c" 2
...
void __attribute__((picinterrupt(("")))) interrup0();
# 6 "main.c" 2
...
void PWM_calc(void){
 active_per = analog / 5;
 flag_time = ( 65536 - (0b00001011 << 4 | 0b11011100 )) * 0b011 * (4 / 4000000);
 pulse_time = active_per * (flag_time * 10 );
}

void __attribute__((picinterrupt(("")))) interrup0(){
 if (INTCONbits.TMR0IF && quantum == 1000){
  read_analog();
  TMR0L = 0b11011100;
  TMR0H = 0b00001011;
  quantum = 0;
 ...
 else if (INTCONbits.TMR0IF && quantum % 10 == pulse_time){
  PORTDbits.RD0 = 1;
  TMR0L = 0b11011100;
  TMR0H = 0b00001011;
  quantum++;
 ...
 else if (INTCONbits.TMR0IF && quantum % 10 == 0){
  PORTDbits.RD0 = 0;
  TMR0L = 0b11011100;
  TMR0H = 0b00001011;
  quantum++;
